...
import {
    ...
    destroy,
    edit,
    index as proyekIndex,
} from '@/routes/admin/proyek';
...
export default function ProyekIndex({ projects, filters }: PageProps) {
    ...
    return (
        <div className="px-4 py-6">
            ...
            <div className="mb-4 flex items-center justify-between gap-4">
                <Heading
                    title="Proyek"
                    description={`${projects.total} proyek`}
                />
                <Button asChild>
                    <Link href={create().url}>+ Proyek baru</Link>
                </Button>
            </div>
                                ...
                                >
                                    ...
                                    <td className="px-4 py-3 text-right">
                                        ...
                                        <DeleteConfirmationDialog
                                            title="Hapus proyek?"
                                            description={`Proyek “${item.title}” akan dihapus secara permanen. Tindakan ini tidak dapat dibatalkan.`}
